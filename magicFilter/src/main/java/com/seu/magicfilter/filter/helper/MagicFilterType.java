...
public class MagicFilterType {	
	...
	public static final int BEAUTY1 = IMAGE_ADJUST + 1;
	public static final int BEAUTY2 = BEAUTY1 + 1;
	public static final int BEAUTY3 = BEAUTY2 + 1;
	public static final int BEAUTY4 = BEAUTY3 + 1;
}
