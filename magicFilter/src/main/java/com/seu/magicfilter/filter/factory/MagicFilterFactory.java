...
public class MagicFilterFactory {
    ...
    public static GPUImageFilter getFilters(int type, Context mContext) {
        ...
        switch (type) {
            ...
            case MagicFilterType.BEAUTY1:
                return new MagicBeautyFilter1(mContext);
            case MagicFilterType.BEAUTY2:
                return new MagicBeautyFilter2(mContext);
            case MagicFilterType.BEAUTY3:
                return new MagicBeautyFilter3(mContext);
            case MagicFilterType.BEAUTY4:
                return new MagicBeautyFilter4(mContext);
            default:
                return null;
        }
    }
